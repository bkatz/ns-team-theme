...
// @jgraup:         Adding multiple methods for changing color and opacity with the keyboard.
	...
	*/
	...
	function input_admin_enqueue_scripts() {
		...
		// register & include JS
		wp_register_script( 'acf-input-rgba_minicolors', THEME_URL . '/admin/acf/acf-rgba-color-master/js/jquery.minicolors.min.js' );
		wp_enqueue_script('acf-input-rgba_minicolors');

		wp_register_script( 'acf-input-rgba_color', THEME_URL . '/admin/acf/acf-rgba-color-master/js/input.js' );
		wp_enqueue_script('acf-input-rgba_color');
		

		// register & include CSS
		wp_register_style( 'acf-input-rgba_color', THEME_URL . '/admin/acf/acf-rgba-color-master/css/input.css' ); 
